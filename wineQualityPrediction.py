...
APP_NAME = "Wine Quality Predictor"
...
if len(arguments) <= 1:
        ...
        testdataresponse = client.get_object(Bucket='sfd6-ml-files',Key='ValidationDataset.csv')
...
client.download_file(Bucket='sfd6-ml-files', Key='RFMLModel.tar.gz', Filename=tarloc)
